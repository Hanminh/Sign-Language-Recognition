...
class SLR_Network(  nn.Module):
    def __init__(self, hidden_size= 1024, kernel_size=5,  num_classes= 1000, dictionary= None, T = 1., beam_size= 50, conv_type =9, conv_improve= False, rnn_type= "LSTM", num_neighbors= [1, 3, 5] ):
